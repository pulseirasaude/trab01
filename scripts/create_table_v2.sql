...
CREATE TABLE MOTORISTA (
  ...
  FOREIGN KEY (ID_CATEGO_CNH)
  REFERENCES KEY CATEGORIA_CNH (ID)
);
...
CREATE TABLE CONTATO (
  ...
  ID_PESSOA INT,
  FOREIGN KEY (ID_TIPO)
  REFERENCES KEY TIPO_CONTATO (ID),
  FOREING KEY (ID_PESSOA)
  REFERENCES KEY PESSOA(ID),
  PRIMARY KEY (ID)
);
